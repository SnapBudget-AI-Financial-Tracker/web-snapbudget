    ...
    <DashboardLayout>
      <div className="p-4 md:p-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="flex items-center gap-2 bg-zinc-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-zinc-800 transition-colors cursor-pointer">
            <Plus size={16} />
            Add Transaction
          </button>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl border border-zinc-200 shadow-sm p-12 text-center">
            ...
            <button className="bg-zinc-100 text-zinc-900 px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-zinc-200 transition-colors border border-zinc-200 cursor-pointer">
              View Sample Guide
            </button>
          </div>
        )}
